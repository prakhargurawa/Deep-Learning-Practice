...
#I changed from keras.models -> tensorflow.keras.models due to compatibilty issues
...
class YOLO:
    def __init__(self, obj_threshold, nms_threshold):
        ...
        self._yolo = load_model('D://Computer-Vision-with-Python/06-Deep-Learning-Computer-Vision/06-YOLOv3/data/yolo.h5')
